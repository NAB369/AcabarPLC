...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    approvals: "Approvals",
    repaymentsNav: "Repayments",
    collectionsNav: "Collections",
    analyticsMenu: "Analytics & Reports",
    creditOfficerPortfolio: "Credit Officer Portfolio",
    accountingModule: "Accounting Module",
    sodEodPanel: "SOD / EOD Panel",
  ...
  km: {
    ...
    sectionCustomers: "អតិថិជន",
    sectionLoans: "ឥណទាន",
    sectionOperations: "ប្រតិបត្តិការ",
    sectionReports: "របាយការណ៍",
    sectionAccounting: "គណនេយ្យ",
    kycReview: "ការពិនិត្យ KYC",
    loansNav: "កម្ចី",
    applyForLoan: "ស្នើសុំកម្ចី",
    approvals: "ការអនុម័ត",
    repaymentsNav: "ការសងប្រាក់",
    collectionsNav: "ការប្រមូលប្រាក់",
    analyticsMenu: "វិភាគ & របាយការណ៍",
    creditOfficerPortfolio: "ផលប័ត្រមន្ត្រីឥណទាន",
    accountingModule: "ផ្នែកគណនេយ្យ",
    sodEodPanel: "ផ្ទាំង SOD / EOD",
    chartOfAccounts: "បញ្ជីគណនី",
    transactionsMenu: "ប្រតិបត្តិការ",
    journalEntry: "ទិនានុប្បវត្តិ",
    incomeEntry: "កត់ត្រាចំណូល",
    expenseEntry: "កត់ត្រាចំណាយ",
    cashTransfer: "ផ្ទេរប្រាក់",
    singleEntry: "កត់ត្រាទោល",
    trialBalance: "តារាងតុល្យការសាកល្បង",
    profitAndLoss: "របាយការណ៍ចំណេញ និងខាត",
    balanceSheet: "តារាងតុល្យការ",
    accountLedger: "សៀវភៅធំ"
  },
  ko: {
    // Sidebar & Menus
    overview: "개요",
    ...
    repaymentsNav: "상환",
    collectionsNav: "추심",
    analyticsMenu: "분석 및 보고서",
    creditOfficerPortfolio: "대출 담당자 포트폴리오",
    accountingModule: "회계 모듈",
    sodEodPanel: "개점 / 마감",
    chartOfAccounts: "계정과목",
    transactionsMenu: "거래",
    journalEntry: "분개장 입력",
    incomeEntry: "수입 입력",
    expenseEntry: "지출 입력",
